 ...
 *   'class' attributes.
 * - $flag_classes: A space-separated list of CSS classes that should be
 *   applied to the link.
 *
 ...
 * - $after_flagging: This template is called for the link both before and
 *   after being flagged. If displaying to the user immediately after flagging,
 *   this value will be boolean TRUE. This is usually used in conjunction with
 *   immediate JavaScript-based toggling of flags.
